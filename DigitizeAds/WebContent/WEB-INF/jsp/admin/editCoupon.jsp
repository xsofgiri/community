...
Coupon couponDetails = request.getAttribute(Constants.ADMIN_COUPON_DETAIL)!=null?(Coupon)request.getAttribute(Constants.ADMIN_COUPON_DETAIL):null;

ArrayList<Advertiser> advertiserList = request.getAttribute(Constants.ALL_ADVERTISER_LIST)!=null?(ArrayList<Advertiser>)request.getAttribute(Constants.ALL_ADVERTISER_LIST):null;
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="top_head_txt">
					<b><p class="padding-top-10">Edit Coupon</p></b>
				</div>
			</div>
				<!-- END PAGE HEADER--> 
		...
		<div class="page-content ">
			...
			<p class="black"><b> <a href="<%=contextPath %>/admin/coupon/viewall">Manage</a></b></p>
		
		<div class="portlet box ">
						<div class="portlet-body form ">
							<form enctype="multipart/form-data" class="form-horizontal" role="form" action="<%=contextPath %>/admin/coupon/edit/<%=CipherUtils.encryptId(couponDetails.getCouponId()+"") %>/" method="post">
								<input type="hidden" name="exImg" value="<%=couponDetails.getSourceLink() %>">
								<div class="form-body"> 
									
									<div class="form-group">
										<label class="col-md-2 control-label">Title</label>
										<div class="col-md-4">
											<input type="text" class="form-control" name="title" id="title" value="<%=couponDetails.getTitle()%>">
										</div>
									</div>
                                    
                                     <div class="form-group">
										<label class="col-md-2 control-label">Select Business Name</label>
										<div class="col-md-4">
											...
											<select class="form-control" name="businessId" id="businessId">
												...
												<%for(Advertiser advertiser : advertiserList){ %>
													<option <%if(couponDetails.getAdvertiser()!=null && advertiser.getAdvertiserId()==couponDetails.getAdvertiser().getAdvertiserId()){ %>selected="selected"<%} %> value="<%=advertiser.getAdvertiserId() %>"><%=advertiser.getName() %></option>
												<%} %>
											</select>
											<%} %> 
										</div>
									...
									<div class="form-group">
										<label class="col-md-2 control-label">Coupon File</label>
										<div class="col-md-4">
										   <input type="file" name="file" id="file" >
										</div>
										
										<embed src="https://adwit-community.s3.ap-south-1.amazonaws.com/coupons/<%=couponDetails.getSourceLink() %>" width="100px" />
									</div>
								...
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-2 control-label">Coupon Text</label>
										<div class="col-md-10">
											<div class="input-icon right">
													<i class="fa fa-map-marker"></i>
													<input type="text" class="form-control" name="couponText" id="couponText" value="<%=couponDetails.getContent()%>">
												</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group  date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
													<input type="text" class="form-control border_ex_right" required name="validFrom" id="validFrom" value="<%=couponDetails.getValidFrom()%>">
													<span class="input-group-btn">
													<button class="btn default num_rad" type="button"><i class="fa fa-calendar"></i></button>
													</span>
												</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group  date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
													<input type="text" class="form-control border_ex_right" required name="validTo" id="validTo" value="<%=couponDetails.getValidTo()%>"> 
													<span class="input-group-btn">
													<button class="btn default num_rad" type="button"><i class="fa fa-calendar"></i></button>
													</span>
												</div>
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<input type="checkbox" name="isFeatured" id="isFeatured" value="1" <%if(couponDetails.isFeatured()){ %>checked="checked"<%} %>>
											<span class="help-inline">check if Featured Coupon</span>
										</div>
									</div>
								</div>
						...
						<!-- BEGIN EXAMPLE TABLE PORTLET-->
							...
							<div class="portlet-body back_white" >
								...
								<div class="margin-top-20">
								        ...
								        <button type="submit" class="btn btn-primary col-md-2">Save Coupon</button>
										</div>
...
<script src="<%=assetsPath %>/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
<script src="<%=assetsPath %>/global/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js"></script>
<script src="<%=assetsPath %>/global/plugins/clockface/js/clockface.js"></script>
<script src="<%=assetsPath %>/global/plugins/bootstrap-daterangepicker/moment.min.js"></script>
<script src="<%=assetsPath %>/global/plugins/bootstrap-daterangepicker/daterangepicker.js"></script>
<script src="<%=assetsPath %>/global/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js"></script>
<script src="<%=assetsPath %>/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
...
<script src="<%=assetsPath %>/admin/pages/scripts/components-pickers.js"></script>
