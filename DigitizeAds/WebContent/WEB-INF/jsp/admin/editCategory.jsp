	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="top_head_txt">
					<b><p class="padding-top-10">Add New Category</p></b>
				</div>
			</div>
				<!-- END PAGE HEADER--> 
		...
		<div class="page-content ">
			...
			<p class="black"><b> <a href="<%=contextPath %>/admin/category/viewall">Manage</a></b></p>
		
		<div class="portlet box ">
						<div class="portlet-body form ">
							<form enctype="multipart/form-data" class="form-horizontal" role="form" action="<%=contextPath %>/admin/category/add" method="post">
								<div class="form-body">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-4">
											...
											<span><a href="https://material.io/resources/icons/?style=baseline" target="_blank">https://material.io/resources/icons/?style=baseline</a></span>
										</div>
									</div>
						...
						<!-- BEGIN EXAMPLE TABLE PORTLET-->
							...
							<div class="portlet-body back_white" >
								...
								<div class="margin-top-20">
								        ...
								        <button type="submit" class="btn btn-primary col-md-2">Add category</button>
										</div>
