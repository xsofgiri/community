	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<div class="top_head_txt">
					<b><p class="padding-top-10">Add New Coupon</p></b>
				</div>
			</div>
				<!-- END PAGE HEADER--> 
		...
		<div class="portlet box ">
						<div class="portlet-body form ">
							<form enctype="multipart/form-data" class="form-horizontal" role="form" action="<%=contextPath %>/admin/coupon/add" method="post">
								<div class="form-body">
										...
										<div class="col-md-4">
											...
											<select class="form-control" name="businessId" id="businessId">
												...
												<%for(Advertiser advertiser : advertiserList){ %>
													<option value="<%=advertiser.getAdvertiserId() %>"><%=advertiser.getName() %></option>
												<%} %>
											</select>
											<%} %> 
										</div>
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group  date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
													<input type="text" class="form-control border_ex_right" required name="validFrom" id="validFrom">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group  date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
													<input type="text" class="form-control border_ex_right" required name="validTo" id="validTo">
													<span class="input-group-btn">
													<button class="btn default num_rad" type="button"><i class="fa fa-calendar"></i></button>
													</span>
												</div>
