...
<html lang="en">
  <head>
    ...
    <title>Community Directory | 500</title>
   ...
   <div class="search-listing-wrap filter-sidebar">
      <div class="listing-wrap grey-bg">
		...
		<div class="row lat-print back-white padding-top-20 ">
			<div class="col-lg-12 col-md-6 col-sm-6 col-xs-6 btm-pad">
				<h3>Something went wrong, while we fix it, <a href="<%=contextPath %>/">Click here</a> to back to home page</h3>
			</div>
		</div>
