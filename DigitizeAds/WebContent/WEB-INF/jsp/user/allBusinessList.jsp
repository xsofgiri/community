          ...
          <div class="row">
            <div class="col">
              <div class="listing-search-block">
                <form action="<%=contextPath %>/business/all/" method="post" name="searchBusinessForm" id="searchBusinessForm">
                  <div class="listing-filter-block"> 
                    <div class="category">
                      <input type="text" class="form-control" name="title" id="title" value="<%=name!=null?name:""%>" placeholder="Search by business title">
                    </div>
                    <button type="submit" value="Submit" class="btn btn-primary" style="padding: 12px 30px;font-size: 1.5rem">Submit</button>
