...
Coupon couponDetails = request.getAttribute(Constants.COUPON_DETAIL)!=null?(Coupon)request.getAttribute(Constants.COUPON_DETAIL):null;
%>
  ...
  <body>
   ...
   <div class="search-listing-wrap filter-sidebar">
      <div class="listing-wrap grey-bg"> 
		...
		<div class="row lat-print back-white padding-top-20 padding-bottom-20 border-bottom">
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 sm-date">
				<div class="section-header" style="text-align: left">
	             <h2 style="text-transform: uppercase;"><%=couponDetails.getTitle() %></h2>
	             </div> 
		...
		<p class="font-16 line"><%=couponDetails.getContent() %></p >
		<div style="margin-top: 20px">
			<h5>Validity</h5>
			<div><%=couponDetails.getValidFrom() %> - <%=couponDetails.getValidTo() %></div>
		</div>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 right btm-10 icons-pad">
		<div class="right">
		<img src="https://adwit-community.s3.ap-south-1.amazonaws.com/coupons/<%=couponDetails.getSourceLink() %>" >	
				</div>
		</div> 
		</div>
