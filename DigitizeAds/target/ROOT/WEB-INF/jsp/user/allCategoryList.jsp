		 ...
		 <div class="row">
            ...
            <div class="col-lg-4">
			 <div class="category-card">
               <a class="card-inner" href="<%=contextPath %>/category/category_slug/category_u_id/">
			    <img src="<%=assetsPath %>/bakers_image/categories/agriculture.jpg" class="img-fluid " alt="">
				<div class="card-info">
                 <div class="name"><span>Auto</span></div>
               </div>
				</a>
				 </div>
			 </div>
